...
*Démarrée — 4/10 sorts d'Élémentalisme.*
...
- Reste 6 sorts d'Élémentalisme, puis Arcane et Ésotérisme ensuite — Arcane demande du contrôle de groupe (ralentissement, immobilisation, déjà amorcé avec `ApplySlow`) ; Ésotérisme demande des invocations (Familier, Golem arcane) qui réutilisent le système `d2mapentity.NPC` mais côté allié, pas ennemi.
