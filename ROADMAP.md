...
*Démarrée — 6/10 sorts d'Élémentalisme, 2/10 Arcane.*
...
- Reste 4 sorts d'Élémentalisme, 8 sorts d'Arcane, puis Ésotérisme ensuite — Ésotérisme demande des invocations (Familier, Golem arcane) qui réutilisent le système `d2mapentity.NPC` mais côté allié, pas ennemi.
